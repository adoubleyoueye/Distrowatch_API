...
INSTALLED_APPS = [
    'distrowatch_api.apps.DistrowatchApiConfig',
    'rest_framework',
    'drf_yasg',
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', default='distrodb'),
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'distrowatch_api.error_handling.custom_exception_handler',
}
